...
public class Curso {
	...
	private List<Aula> aulas = new ArrayList<Aula>(); // Agregação de classes para usa-las na classe "Curso"
	private Set<Aluno> alunos = new HashSet(); // Agregação de classes para usa-las na classe "Curso"
