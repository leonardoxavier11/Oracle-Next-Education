...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		btnLogin.setBounds(705, 300, 83, 70);
		...
		// Botón Criar
		JLabel lblTitulo_1 = new JLabel("CRIAR");
		lblTitulo_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitulo_1.setForeground(SystemColor.textHighlight);
		lblTitulo_1.setFont(new Font("Dialog", Font.PLAIN, 20));
		lblTitulo_1.setBackground(SystemColor.window);
