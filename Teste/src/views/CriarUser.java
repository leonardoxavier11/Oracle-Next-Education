...
public class CriarUser extends JFrame {
	...
	public CriarUser() {
		...
		imgHotel.setIcon(new ImageIcon(CriarUser.class.getResource("/imagenes/img-hotel-login-.png")));
		...
		JLabel lblEntrar = new JLabel("CRIAR");
		...
		logo.setIcon(new ImageIcon(CriarUser.class.getResource("/imagenes/lOGO-50PX.png")));
	...
	//Método para criar um usuário autenticado
	private void criarUser() throws SQLException {

		String Usuario = new String(txtUsuario.getText());
		String Senha = new String(txtSenha.getPassword());

		User usuarioComSenha = new User(Usuario, Senha);
		UserController userController = new UserController();

		if (!userController.verificarSeJaExiste(usuarioComSenha.getUsuario())) {
			userController.persistir(usuarioComSenha);
			MenuPrincipal menu = new MenuPrincipal();
			menu.setVisible(true);
			dispose();
		} else {
			JOptionPane.showMessageDialog(this, "Usuario já existe no banco de dados");
		}
	}
